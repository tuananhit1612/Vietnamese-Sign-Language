...
df_csv = pd.read_excel("C:/Users/ADMIN/Desktop/Dataset/train.xlsx")
...
output_dir = "C:/Users/ADMIN/Desktop/Dataset/train_landmark_files"
os.makedirs(output_dir, exist_ok=True)

for _, row in df_csv.iterrows():
    video_path = f"C:/Users/ADMIN/Desktop/Dataset/Video_Full/{row['file_id']}.mp4"
    file_id = row['file_id']
